 ...
 * @var \App\Model\Entity\TblLookup $tblLookup
 */
?>
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(__('Delete Lookup'), ['action' => 'delete', $tblLookup->id], ['confirm' => __('Are you sure you want to delete # {0}?', $tblLookup->id)]) ?> </li>
