 ...
 *
 * @method \App\Model\Entity\Yii\Comment[]|\Cake\Datasource\ResultSetInterface paginate($object = null, array $settings = [])
 */
class TblCommentController extends AppController
{
    ...
    public function add()
    {
        ...
        $tblPost = $this->TblComment->TblPost->find('list', ['limit' => 200]);
        $this->set(compact('tblComment', 'tblPost'));
    }
